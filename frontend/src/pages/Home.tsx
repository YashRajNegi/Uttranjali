    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow bg-background pt-20 md:pt-24 px-2 md:px-0">
        <div className="container-custom">
          {/* Hero Section */}
          <section ref={heroRef} className="bg-organic-primary text-white py-12 md:py-20 overflow-hidden relative">
            <div className="container mx-auto px-4 max-w-2xl md:max-w-4xl">
              ...
              <motion.p
                ...
                className="text-base sm:text-lg md:text-2xl mb-8 text-center"
              >
          ...
          {/* Features Section */}
          <section ref={featuresRef} className="py-10 md:py-16 bg-white">
          ...
          <section className="py-10 md:py-20 bg-gray-50">
            <div className="container mx-auto px-2 sm:px-4 flex flex-col md:flex-row items-center gap-8 md:gap-12 max-w-2xl md:max-w-4xl">
              <motion.div
                ...
                transition={{ duration: 0.8, ease: 'easeOut' }}
              >
                <img src={aboutImg} alt="About Earth Eats Market" className="rounded-xl shadow-lg w-full object-cover max-h-60 sm:max-h-80 md:max-h-96" />
              </motion.div>
              <motion.div
