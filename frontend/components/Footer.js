      ...
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/products?category=fruits" className="text-organic-secondary hover:text-organic-primary transition-colors">
                  Fresh Fruits
                </Link>
              </li>
              <li>
                <Link href="/products?category=vegetables" className="text-organic-secondary hover:text-organic-primary transition-colors">
                  Vegetables
                </Link>
              </li>
              <li>
                <Link href="/products?category=pantry" className="text-organic-secondary hover:text-organic-primary transition-colors">
                  Pantry Essentials
                </Link>
              </li>
              <li>
                <Link href="/products?category=grains" className="text-organic-secondary hover:text-organic-primary transition-colors">
                  Grains & Cereals
                </Link>
              </li>
            </ul>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center text-sm text-organic-secondary">
          ...
          <div className="flex space-x-4 mt-3 md:mt-0">
            <Link href="/privacy" className="hover:text-organic-primary transition-colors">
              Privacy Policy
            </Link>
            <Link href="/terms" className="hover:text-organic-primary transition-colors">
              Terms of Service
            </Link>
          </div>
        </div>
